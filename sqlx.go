...
import (
    ...
    "github.com/CharLemAznable/sqlx/reflectx"
)
...
func (q *qStmt) Select(dest interface{}, query string, args ...interface{}) error {
    return q.Stmt.Select(dest, args)
}

func (q *qStmt) Get(dest interface{}, query string, args ...interface{}) error {
    return q.Stmt.Get(dest, args)
}
